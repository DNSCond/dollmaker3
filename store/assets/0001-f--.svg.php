<svg>
    <g class="head">
        <path d="M 350 260 v 130 l 50 50 l 50 -50 v -130 Z" fill="<?= "{$GLOBALS['skin']}" ?>" class="neck"
              stroke-width="8"
              stroke="#000000"/>
        <ellipse rx="150" ry="100" cx="400" cy="200" fill="<?= "{$GLOBALS['skin']}" ?>" stroke-width="8"
                 stroke="#000000"/>
        <ellipse rx="20" ry="40" cx="350" cy="220" fill="<?= "{$GLOBALS['eyes']}" ?>" stroke-width="8"
                 stroke="#000000"/>
        <ellipse rx="20" ry="40" cx="450" cy="220" fill="<?= "{$GLOBALS['eyes']}" ?>" stroke-width="8"
                 stroke="#000000"/>
    ...
    <path d="M 170 450 m -10 -50 L 305 420 L 350 400 L 400 425 L 450 400 L 495 420 L 640 400 l 20 100 L 500 500 L 640 1260 H 160 L 300 500 L 140 500 Z"
          fill="<?= "{$GLOBALS['bgcolor']}" ?>" stroke-width="8" stroke="#000000"
          class="mainframe"/>
</svg>